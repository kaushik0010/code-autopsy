...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'NotifyDiscord': EventHandler<{ repoName: string; jobId: number; prUrl: string; analysis: { rootCause: string; filePath: string } }, never>
    ...
    'CreateFixPR': EventHandler<{ repoName: string; jobId: number; analysis: { rootCause: string; filePath: string; suggestedFix: string; explanation: string } }, { topic: 'pr-created'; data: { repoName: string; jobId: number; prUrl: string; analysis: { rootCause: string; filePath: string } } }>
